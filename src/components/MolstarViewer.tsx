        ...
        const spec = minimalUI ? {
          ...
          layout: {
            initial: {
              ...
              showControls: true,
              controlsDisplay: 'reactive' as const,
              // Use 'collapsed' from the start - panels are visible but minimized
              // User requirement: must be collapsed, not hidden
              regionState: {
                left: 'collapsed' as const,    // State Tree
                right: 'collapsed' as const,   // Structure Tools
                top: 'collapsed' as const,     // Sequence View
                bottom: 'hidden' as const,
              }
            }
          },
